...
class DenseRetrieval:
    ...
    def get_p_embs(self,text):
        ...
        self.dense_dataloader = DataLoader(
            dense_dataset,
            batch_size=self.args.per_device_train_batch_size,
            drop_last = True
        )
        with torch.no_grad():
            ...
            self.p_embs = []
            for batch in self.dense_dataloader:
    ...
    def get_relevant_doc(self,
        ...
        print(p_embs.shape)
        print(q_emb.shape)
        print(torch.transpose(p_embs, 0, 1).shape)
